...
class SettingsDialog(QDialog):
    ...
    SECTIONS = {
        ...
        'Processing': {
            ...
            'reading_time_multiplier': (float, _("Scale the estimated speaking time of a subtitle when extending short subtitles (1.0 = normal speed, higher values give more reading time)")),
    ...
    VISIBILITY_DEPENDENCIES = {
        ...
        'reading_time_multiplier': _duration_setting,
