...
class SettingsDialog(QDialog):
    ...
    VISIBILITY_DEPENDENCIES = {
        ...
        'seconds_per_character': { 'extend_short_subtitles': True, 'use_netflix_timing_guide': False },
        'use_netflix_timing_guide': _duration_setting,
        'netflix_timings_adjustment': { 'extend_short_subtitles': True, 'use_netflix_timing_guide': True },
